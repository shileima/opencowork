...
let setCurrentRpaTaskIdFn: ((taskId: string | null) => void) | null = null;

export function registerContextSwitchHandler(fn: (taskId: string | null) => void): void {
    setCurrentTaskIdFn = fn;
}

export function registerRpaContextSwitchHandler(fn: (taskId: string | null) => void): void {
    setCurrentRpaTaskIdFn = fn;
}
...
export function setCurrentRpaTaskIdForContextSwitch(taskId: string | null): void {
    if (setCurrentRpaTaskIdFn) {
        setCurrentRpaTaskIdFn(taskId);
    }
}
