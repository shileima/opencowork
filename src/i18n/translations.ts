export const translations = {
    en: {
        ...
        projectNameRule: 'Must start with a letter; only letters, numbers, and underscores allowed.',
    ...
    zh: {
        ...
        projectNameRule: '英文开头，仅可包含英文、数字、下划线',
        projectPath: '项目路径',
        createProject: '创建项目',
