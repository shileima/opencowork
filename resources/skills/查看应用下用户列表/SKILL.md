---
name: 查看应用下用户列表
description: 查看目标应用下的所有用户。当需要调用此工具API、执行查看应用下用户列表操作时使用。
...
bash ../_skill-common/scripts/execute.sh \
  --skill-id "skill-53ea05ea-b" \
  --parameters '{"workspace_id":"example_workspace_id","base_id":"example_base_id","token":"example_token"}'
```
